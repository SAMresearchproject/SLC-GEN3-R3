# Primitive Stack Lock and Replay Register

[Back to tests](README.md)

Test identity: `LC:LC01`.

## Wrong control

Provides the primitive/source lock and global register of mutation, leakage, type-conflation and application-specific wrong controls.

**Question:** Does LC01 freeze the primitive/source stack and register diagnostic mutations precisely enough that later lane failures can be attributed to the changed dependency rather than an untracked implementation difference?

**Calculation:** Inspect the LC01 primitive lock and replay register for explicit source custody, mutation identity, expected diagnostic role and downstream lane inheritance.

**Recorded outcome:** LC01 provides the locked primitive/source base and a durable wrong-control register that later replays can cite, execute and preserve even when a control or lane fails.

**Scope of this result:** LC01 establishes custody and diagnostic alternatives; it neither pre-awards later lane outcomes nor makes its control roster mandatory for unrelated exploratory campaigns.

**Controls:**

- Exact primitive and source hashes.
- One declared mutation per diagnostic route where applicable.
- Separation of mathematical failure from implementation fault.

**Diagnostic comparisons:**

- Parameter mutation after viewing a target.
- Cross-lane source leakage.
- Endpoint/road or local/global type conflation.
- Application-specific operator substitutions preserved in the register.

## Premise

Illustrates the first executable lock step that fixes premises, sources and controls without pre-awarding later lane results.

**Question:** Does LC01 preserve a replayable source and control lock that allows later results, failures and corrections to be traced without collapsing them into approval or live authority?

**Calculation:** Inspect the LC01 lock as the executable custody step and trace how its sources, primitives and wrong-control register constrain later replays and promotion decisions.

**Recorded outcome:** LC01 fixes the executable source/control base for successors while leaving every later result, classification, document revision and approval state to be recorded independently.

**Scope of this result:** This route demonstrates custody within a promotion chain; it does not claim that LC01 or any downstream artifact is owner-approved, public or live because it validates mechanically.

**Controls:**

- Source and primitive identity.
- Explicit replay dependencies.
- Null approval unless Sean Brady approves the exact revision.

**Diagnostic comparisons:**

- Silent source replacement.
- Erasure of failed or bug-affected predecessors.
- Automatic promotion after a passing validator.

[Read the original test](../../../courtroom/16_THE_LAST_CAMPAIGN/LC01_result.md)
...
```json
{
  ...
  "approval": null,
  "description": "Primitive Stack Lock and Replay Register",
  "family": "LC",
  "keywords": [
    "Primitive",
    "Stack",
  ...
  "qualified_test_id": "LC01",
  "record_key": "LC:LC01",
  "related_test_ids": [],
  "reviewed_and_approved": false,
  "source_basis": "LAST_CAMPAIGN_RESULT",
  "source_commit": "b5e914f71377e86ef4c67e199973d9300795cda1",
  "source_path": "16_THE_LAST_CAMPAIGN/LC01_result.md",
  "source_repo": "The_Courtroom",
  "source_sha256": "9e3f698f5fc99e559b8cebe2dbcf30c2acc22e27f691d9cbb871c99003b866e2",
  "source_status": null,
  "source_url": "../../../courtroom/16_THE_LAST_CAMPAIGN/LC01_result.md",
  "source_verdict": null,
  "test_id": "LC01",
  "volume_numbers": [
    "I",
...
[Open the primary source record](../../../courtroom/16_THE_LAST_CAMPAIGN/LC01_result.md) · [All 164 package files](../../../tests/courtroom/16-the-last-campaign/README.md) · [Browse the source directory in CR](../../../courtroom/16_THE_LAST_CAMPAIGN)
