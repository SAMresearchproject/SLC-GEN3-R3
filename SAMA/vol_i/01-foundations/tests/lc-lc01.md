...
Routes Primitive Stack Lock and Replay Register as a retest in the partition, radix and carrier closure chain while preserving the source artifact and its historical status fields.

**Question:** For LC:LC01: Does the diagonal grammar select the declared connector set and R12 packet, reproduce the closed sector identities and reject incomplete radix or carrier substitutions?
...
**Recorded outcome:** The permanent registry identifies LC:LC01 as ‘Primitive Stack Lock and Replay Register’. The registry exposes no structured status or verdict, so the pinned source artifact remains the detailed outcome authority and this crosswalk adds no verdict.
...
Routes Primitive Stack Lock and Replay Register as a retest in the universal-floor derivation and replay chain while preserving the source artifact and its historical status fields.

**Question:** For LC:LC01: Do the foundation derivation and locked replay recover A0=1/(12π) and preserve its different treatment under pointwise, gradient, endpoint and global operators?

**Calculation:** Derive A0 and replay its operator-dependent cancellation or retention rules.

**Recorded outcome:** The permanent registry identifies LC:LC01 as ‘Primitive Stack Lock and Replay Register’. The registry exposes no structured status or verdict, so the pinned source artifact remains the detailed outcome authority and this crosswalk adds no verdict.

**Scope of this result:** The floor is universal in the substrate account; visible contribution remains operator-specific.

**Controls:**

- Exact symbolic and numerical equality.
- Typed-operator audit.

**Diagnostic comparisons:**

- Treating A0 as a fitted offset.
- Inserting or deleting the floor without declaring the readout operator.
