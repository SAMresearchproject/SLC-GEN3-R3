...
Routes qA Ledger Compression / Gravity-As-A Replay as a retest in the closed source to spherical accumulation chain while preserving the source artifact and its historical status fields.

**Question:** For LC:LC03: Does the typed source route recover A(r)=r_s/r, weak-field contact and locked gravity-as-A replay without substituting qA or carrier count directly for mass?
