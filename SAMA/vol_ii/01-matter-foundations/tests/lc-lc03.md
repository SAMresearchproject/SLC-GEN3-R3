...
qA Ledger Compression / Gravity-As-A Replay enters Matter Boundary and Finite Closure as retest evidence. The locked replay retains q_A, T and W as compressed source-support channels rather than measured rest mass.

**Question:** Does the source-defined qA Ledger Compression / Gravity-As-A Replay route supply the scoped evidence required by Matter is finite closed form, not substrate, One-eighth carrier and seven-eighths retained support, Source support is not measured rest mass while preserving its declared boundary?
