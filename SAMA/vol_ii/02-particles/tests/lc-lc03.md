...
qA Ledger Compression / Gravity-As-A Replay enters Mass, Lift, Debit and Particle Readout as retest evidence. The locked replay retains q_A, T and W as compressed source-support channels rather than measured rest mass.

**Question:** Does the source-defined qA Ledger Compression / Gravity-As-A Replay route supply the scoped evidence required by Source support is not measured rest mass while preserving its declared boundary?
