...
qA Ledger Compression / Gravity-As-A Replay enters Carrier/Container Return to Accumulation as source anchor evidence. The locked replay retains q_A, T and W as compressed source-support channels rather than measured rest mass.

**Question:** Does the source-defined qA Ledger Compression / Gravity-As-A Replay route supply the scoped evidence required by One-eighth carrier and seven-eighths retained support, Source support is not measured rest mass, Typed matter-to-computation serialization contract while preserving its declared boundary?

**Calculation:** Execute or replay the source-defined qA Ledger Compression / Gravity-As-A Replay operator over its pinned roster in the declared operation order.

**Recorded outcome:** The locked replay retains q_A, T and W as compressed source-support channels rather than measured rest mass.

**Scope of this result:** q_A, T and W remain source-support channels, not measured particle rest mass.
