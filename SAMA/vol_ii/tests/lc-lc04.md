# Particle Mass-Chain Table Replay

[Back to tests](README.md)

Test identity: `LC:LC04`.

The complete public Courtroom package and related-test links are provided below.

[Read the original test](../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_result.md)
...
```json
{
  ...
  "approval": null,
  "description": "Particle Mass-Chain Table Replay",
  "family": "LC",
  "keywords": [
    "particle",
    "mass",
  ...
  "qualified_test_id": "LC04",
  "record_key": "LC:LC04",
  "related_test_ids": [],
  "reviewed_and_approved": false,
  "source_basis": "LAST_CAMPAIGN_RESULT",
  "source_commit": "b5e914f71377e86ef4c67e199973d9300795cda1",
  "source_path": "16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_result.md",
  "source_repo": "The_Courtroom",
  "source_sha256": "dc7f05ec414cadba1872ea5d80e71a5c52ecef409894a83f037bbf9cef9382bc",
  "source_status": null,
  "source_url": "../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_result.md",
  "source_verdict": null,
  "test_id": "LC04",
  "volume_numbers": [
    "I",
...
[Open the primary source record](../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_result.md) · [All 9 package files](../../tests/courtroom/16-the-last-campaign-lc04-particle-mass-chain-table-replay/README.md) · [Browse the source directory in CR](../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY)

Package: `16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY`. This includes **0 code files** and **2 files categorized as results or reports**, plus all inputs, figures and other tracked files. The full inventory is unabridged.

### Wrong controls and comparison rows

- [LC04_wrong_controls.csv](../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_wrong_controls.csv)

<details>
<summary>Results and reports</summary>

- [LC04_result.md](../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_result.md) — [raw](../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_result.md)
- [LC04_summary.json](../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_summary.json) — [raw](../../courtroom/16_THE_LAST_CAMPAIGN/LC04_PARTICLE_MASS_CHAIN_TABLE_REPLAY/LC04_summary.json)
