"""Four-worker root compiler for the v0.2.1 linked N72 supercell."""
...
CAMPAIGN_ID = "SLCV0021C4N72_LINKED_SUPERCELL_EXACT_N72"
CHECKPOINT_DOMAIN = "SLCV0021-LINKED-SUPERCELL-ROOT-BATCH-V1"
...
def load_engine(engine_path: Path) -> Any:
    name = "slcv0021_sealed_slcx032_engine"
...
def validate_checkpoint(
    ...
    if (
        ...
        or any(not isinstance(row, list) or len(row) != root_count for row in evaluations)
    ):
...
def node_loop(
    ...
    try:
        ...
        while True:
            ...
            unsigned = {
                "schema": "SLCV0021_LINKED_ROOT_BATCH_CHECKPOINT_V1",
