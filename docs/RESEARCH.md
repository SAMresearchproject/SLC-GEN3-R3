# SAM research through SLC

This index connects the computational engine to its research applications.
The snapshots below are dated14 September2026; each result keeps its original
workload, engine and source identity. The [source index](../research/SOURCE_INDEX.md)
identifies the current authorities used for this update.

| Area | Current computational work and retained result |
|---|---|
|[RH](../research/rh/README.md)|Exact signed forcing, original-kernel spectral control, smaller-source transfer and conditional growth implications;12,836 complete excess prefixes. Uniform arithmetic growth remains open.|
...
The tau learned-bundle comparison changes direction error+0.40%, identification
AUROC+0.000044002 and decay F1−0.000063404 against its selected references.
These mixed outcomes are retained with their own scope; the pilot is not
summarized as a uniform improvement across all three tasks.

[Volume I](../SAMA/vol_i/README.md) covers substrate and cosmology;
[Volume II](../SAMA/vol_ii/README.md) matter and carriers;
[Volume III](../SAMA/vol_iii/README.md) computation and SLC;
