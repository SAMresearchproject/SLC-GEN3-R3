...
Installed build: GEN3-BETHE1-20260917. Global SLC and CE are
...
## Bethe algebra and construction — R4

Five exact Bethe/construction operations add left/right module closure, sparse products, polynomial corrections, regular local obstruction certificates, construction evaluation and retained export. [Contracts](BETHE.md).
