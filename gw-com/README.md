...
- [Program overview and five-layer architecture](GW_COM/README.md)
- [Exactly three follow-up tests: noise/SNR, physical scaling, natural-carrier false positives](SAM_REVIEW/campaigns/GW_COM_THREE_TESTS1/REPORT.md)
- [Continuous controlled-source report](SAM_REVIEW/campaigns/GW_COM_CONTINUOUS1/REPORT.md)
- [Corrected seven-prime pipeline](SAM_REVIEW/campaigns/GW_COM_PIPELINE2/RESULT.md)
- [Publication/reproduction scope](GW_COM/PUBLICATION.md)
- [Source synchronization metadata](GW_COM/SYNC_SOURCE.json)
