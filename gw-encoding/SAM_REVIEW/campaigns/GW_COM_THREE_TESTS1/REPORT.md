# GW-COM: exactly three follow-up tests
...
- **Continuous noise sweep:** 4/6 prime injections decoded the full corrected payload; 0/6 matched unmodulated cases passed the repetition/permutation criteria. Detailed outcomes, including unsuccessful recoveries, appear below.
...
- **Natural-carrier cases:** 0/2 nuisance waveforms passed the repeated-packet statistical criteria. Carrier-fit adequacy and packet results are reported separately.
...
|---:|---:|---:|---:|---:|
| 0.01 | 37.635 | 3736.68 | 2/2 | 0/2 |
| 0.05 | 7.527 | 747.336 | 2/2 | 0/2 |
| 0.2 | 1.8817 | 186.834 | 0/2 | 0/2 |

| σ | Seed | Source | Adequate fit | Markers | Repeats | Permutation p | Admitted | Exact payload |
|---:|---:|---|---|---:|---:|---:|---|---|
| 0.01 | 20260917 | prime | True | 22 | 2 | 1/100 | True | True |
| 0.01 | 20260917 | unmodulated | True | 0 | 0 | 1 | False | Not decoded |
| 0.01 | 20260918 | prime | True | 22 | 2 | 1/100 | True | True |
| 0.01 | 20260918 | unmodulated | True | 0 | 0 | 1 | False | Not decoded |
| 0.05 | 20260917 | prime | True | 22 | 2 | 1/100 | True | True |
| 0.05 | 20260917 | unmodulated | True | 0 | 0 | 1 | False | Not decoded |
| 0.05 | 20260918 | prime | True | 22 | 2 | 1/100 | True | True |
| 0.05 | 20260918 | unmodulated | True | 0 | 0 | 1 | False | Not decoded |
| 0.2 | 20260917 | prime | True | 287 | 0 | 1 | False | Not decoded |
| 0.2 | 20260917 | unmodulated | True | 320 | 0 | 1 | False | Not decoded |
| 0.2 | 20260918 | prime | True | 324 | 0 | 1 | False | Not decoded |
| 0.2 | 20260918 | unmodulated | True | 358 | 0 | 1 | False | Not decoded |
...
|---|---:|---:|---:|---:|---:|---:|
| small_compact_pair | 1e+20 | 25 | 326.786 | 104.019 | 1.88503 | 2.7251e-05 |
| stellar_compact_pair | 2.78386e+30 | 200000 | 76.1994 | 24.255 | 8.08406 | 0.0508348 |
...
|---|---:|---:|---:|---:|
| small_compact_pair | 1 | 1.429776e-32 | 5.638916e-33 | 6.675871e-34 |
| small_compact_pair | 1000 | 1.429776e-35 | 5.638916e-36 | 6.675871e-37 |
| small_compact_pair | 1e+06 | 1.429776e-38 | 5.638916e-39 | 6.675871e-40 |
| stellar_compact_pair | 1 | 1.385072e-15 | 5.462605e-16 | 6.467137e-17 |
| stellar_compact_pair | 1000 | 1.385072e-18 | 5.462605e-19 | 6.467137e-20 |
| stellar_compact_pair | 1e+06 | 1.385072e-21 | 5.462605e-22 | 6.467137e-23 |
...
|---|---:|---:|---:|
| small_compact_pair | 1 | 2.98845e-09 | 3.79544e-10 |
| small_compact_pair | 1000 | 2.98845e-12 | 3.79544e-13 |
| small_compact_pair | 1e+06 | 2.98845e-15 | 3.79544e-16 |
| stellar_compact_pair | 1 | 1.51091e+08 | 5.25539e+07 |
| stellar_compact_pair | 1000 | 151091 | 52553.9 |
| stellar_compact_pair | 1e+06 | 151.091 | 52.5539 |

| Source | Formal distance at known-modulation ρ=8 (pc) | Distance / GW wavelength | Wave-zone interpretation |
|---|---:|---:|---|
| small_compact_pair | 4.7443e-11 | 0.507943 | Not a far-zone horizon; formal extrapolation only |
| stellar_compact_pair | 6.56924e+06 | 1.64001e+16 | Far-zone extrapolation; see ratio |
...
|---|---:|---:|---:|---:|---:|---:|
| small_compact_pair | 1.806564e+26 | 1.645571e+27 | 3.620256e+28 | 3.356443e+09 | 4.97126e+17 | 9.47963e-19 |
| stellar_compact_pair | 2.187599e+39 | 1.594119e+44 | 3.507062e+45 | 1.712635e+42 | 94.3811 | 0.0214133 |
...
|---|---|---:|---:|---:|---|---|
| precession_like | False | 1 | 0 | 1 | False | False |
| slow_chirp | False | 0 | 0 | 1 | False | False |
...
The suite completed **466 native calls and 4,506,394 graph nodes**. [Native session and receipts](../../../SAM_REVIEW/campaigns/GW_COM_THREE_TESTS1/run001/sessions/STARBREAKER_66472e62588448c3a50eac79cef298ce/), [complete result](run001/records/RUN_RESULT.json), [frozen method/source inventory](run001/METHOD.json), and [validation](run001/VALIDATION.json) are retained.

Saved-output verification passed 168 evidence records, 138,012 raw channel samples, 276,024 exact prediction/residual channel samples, 84 normal equations, 14 permutation-rank outcomes, two physical scalings and six distance rows. Verification generated no additional scientific cases.
