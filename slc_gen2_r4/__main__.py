...
def main():
    parser = argparse.ArgumentParser(description="SLC-GEN2-R4 — research use only")
    ...
    if args.command == "info":
        print(encoded({"engine": "SLC-GEN2-R4", "generation": current_generation(),
    ...
    try:
        ...
        receipt = {"status": "RETURNED", "engine": "SLC-GEN2-R4", "generation": current_generation(),
